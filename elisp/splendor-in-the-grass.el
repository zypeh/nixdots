;;; splendor-in-the-glass.el --- -*- lexical-binding: t; -*-
;;
;; Just like the cover of the Pink Martini's "SPENDOR IN THE GRASS", inspired by
;; the vivid-theme actually.
;;
;; Copyright (C) 2020 Zheng Yan PEH
;;
;; Author: Zheng Yan PEH <http://github/zypeh>
;; Maintainer: Zheng Yan PEH <zypeh.geek@gmail.com>
;; Created: September 07, 2020
;; Modified: September 07, 2020
;; Version: 0.0.1
;; Keywords:
;; Homepage: https://github.com/zypeh/bebop-theme
...
(deftheme splendor-in-the-grass
  "Vivid light color theme inspired by vivid theme and Pink Martini's song
cover.")
...
(provide-theme 'splendor-in-the-grass)
;;; splendor-in-the-grass.el ends here
